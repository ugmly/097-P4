...
<head>
  ...
  <!-- Bootstrap CSS -->
  <link href="<?= base_url('assets/bootswatch-5/dist/Vapor/bootstrap.min.css')
              ?>" rel="stylesheet">
</head>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarColor01">
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item">
            <a class="nav-link <?php echo $active_menu =='data_barang' ? 'active' : ''; ?>" href="<?= site_url('Home/index') ?>">Data Barang</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php echo $active_menu == 'tentang' ?'active' : ''; ?>" href="<?= site_url('Home/tentang') ?>">Tentang</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="container mt-5 mb-5">
    ...
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top border-2">
      ...
      <div class="col-md-4 d-flex align-items-center">
        ...
        <span class="text-muted">©2024 Praktikum TIF, <b>ULUNG GALIH MAHANDARU</b> |
          1412220097</span>
      </div>
    </footer>
  </div>
